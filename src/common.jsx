...
export const  [state, setState] = createSignal(STATE_INIT);
export const [speed, setSpeed] = createSignal("0");
export const [time, setTime] = createSignal("00:00");
export const [heading, setHeading] = createSignal("0");
export const LINE_NONE = 0;
export const LINE_PORT = 1;
export const LINE_STBD = 2;
export const LINE_BOTH = LINE_PORT | LINE_STBD;
export const [line, setLine] = createSignal(LINE_NONE);
